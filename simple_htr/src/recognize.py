...
def save_img(dataurl):
	ext = dataurl.split(';base64,')[0]
	ext = ext.split('data:image/')[1]
	s = dataurl.split(';base64,')[1]
...
def getTextIcr(dataurl):
	img_pth=save_img(dataurl)
